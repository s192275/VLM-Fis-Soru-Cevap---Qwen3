...
**Özellikler**
  ...
  Qwen3 Multimodal Model (Vision + Language)

  Fatura / Fiş / Vergi Belgesi Görsel Desteği

  Görsel üzerinden doğal dilde soru–cevap

  Streamlit Web Arayüzü

  Türkçe belge ve soru desteği

  GPU / CPU uyumlu çalışma

**Kullanım Senaryoları**

  . Fatura tutarı, KDV oranı, tarih, firma adı sorgulama

  . Vergi belgelerinde alan bazlı analiz

  . Muhasebe ön kontrol otomasyonu
